...
export default function useHistory(initialState, session) {
  ...
  // Ensure we always return a valid elements array, never undefined
  const currentElements = history[index] || [];
  
  return [currentElements, setState, undo, redo, history, index];
}
